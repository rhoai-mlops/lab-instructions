...
6. You can also go to OpenShift AI Dashboard, under `AI hub`, select `Model Deployments` in the left menu and then select one of the two projects to see the deployed models, just like we did in the inner loop.
